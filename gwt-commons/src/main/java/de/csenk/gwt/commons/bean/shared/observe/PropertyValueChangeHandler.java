...
public interface PropertyValueChangeHandler<T> extends EventHandler {
	...
	/**
	 * Called when {@link PropertyValueChangeEvent} is fired.
	 * 
	 * @param event the {@link PropertyValueChangeEvent} that was fired
	 */
	void onPropertyValueChange(PropertyValueChangeEvent<T> event);
